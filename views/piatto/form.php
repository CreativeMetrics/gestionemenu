...
<form method="post" action="/piatti" class="card">
    <?= Csrf::field() ?>
    ...
    <input type="text" id="prezzo_testo" name="prezzo_testo" value="" placeholder="es. 18 oppure € 20 / +€ 7,5">
    ...
    <input type="text" id="tracce_di" name="tracce_di" value="" placeholder="es. Frutta a Guscio, Sesamo">

    <label for="note_interne">Note interne (non visibili in stampa)</label>
    <textarea id="note_interne" name="note_interne"></textarea>
...
<p class="help-text">
    Dopo aver salvato potrai aggiungere foto e vedere lo storico dalla scheda del piatto.
</p>
